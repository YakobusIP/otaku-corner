...
import FilterAuthor from "@/features/media-list/components/filter-sort-dropdowns/FilterAuthor";
...
import MangaCard from "@/features/media-list/domains/manga/MangaCard";

import type { MediaListClientConfig } from "@/types/context.type";
import type { MangaFilters, MangaList } from "@/types/manga.type";

import { mangaListQueryConfig } from "@/features/media-list/lib/manga-list-query";
