...
import ReviewContent from "@/features/media-detail/components/ReviewContent";
import MediaDetailScoresBreakdown from "@/features/media-detail/components/scores-breakdown/MediaDetailScoresBreakdown";
