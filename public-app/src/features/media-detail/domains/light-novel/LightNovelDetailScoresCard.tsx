import MediaDetailScoresCardCore from "@/features/media-detail/components/MediaDetailScoresCardCore";

import { LightNovelDetail } from "@/types/lightnovel.type";

import { formatLightNovelVolumesLabel } from "@/features/media-detail/lib/media-detail-helpers";
