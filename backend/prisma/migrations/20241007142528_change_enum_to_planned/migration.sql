/*
  ...
  - The values [PLAN_TO_WATCH] on the enum `ProgressStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ProgressStatus_new" AS ENUM ('PLANNED', 'ON_HOLD', 'WATCHING', 'COMPLETED', 'DROPPED');
