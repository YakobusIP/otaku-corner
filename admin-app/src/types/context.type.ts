...
type ScoreKey = ScoreOption["key"];
const scoreKeys = scoreOptions.map((o) => o.key) as [ScoreKey, ...ScoreKey[]];
...
const _AnimeStateSchema = z.object({
  ...
  filters: z.object({
    ...
    malScore: z.enum(scoreKeys).optional(),
    personalScore: z.enum(scoreKeys).optional(),
