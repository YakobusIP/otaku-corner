...
import StudioConsumptionChart from "@/components/dashboard/StudioConsumptionChart";
import ThemeConsumptionChart from "@/components/dashboard/ThemeConsumptionChart";
import {
  Card,
  CardContent,
  CardDescription,
