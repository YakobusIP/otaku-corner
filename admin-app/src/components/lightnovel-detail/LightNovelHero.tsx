        ...
        <div className="relative flex justify-center tablet:block desktop:block">
          <div className="relative shrink-0">
            ...
            <img
              ...
              className="relative h-[260px] w-[185px] rounded-xl border border-border/60 object-cover shadow-2xl sm:h-[320px] sm:w-[225px] tablet:h-[280px] tablet:w-[200px] lg:h-[340px] lg:w-[240px] xl:h-[400px] xl:w-[280px]"
            />
          </div>
        </div>
