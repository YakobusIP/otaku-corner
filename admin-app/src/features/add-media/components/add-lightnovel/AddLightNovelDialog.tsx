...
import LightNovelDetailPanel from "@/features/add-media/components/add-lightnovel/LightNovelDetailPanel";
...
import { useAddLightNovelDialog } from "@/features/add-media/hooks/useAddLightNovelDialog";
