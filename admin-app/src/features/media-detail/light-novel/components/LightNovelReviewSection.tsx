import ProgressStatus from "@/features/media-detail/shared/components/ProgressStatus";
import RatingSelect from "@/features/media-detail/shared/components/RatingSelect";
import ReviewEditor from "@/features/media-detail/shared/components/ReviewEditor";
import VolumeProgressModal from "@/features/media-detail/light-novel/components/VolumeProgressModal";
import { Button } from "@/components/ui/button";
import { Label } from "@/components/ui/label";

import { useLightNovelReviewSection } from "@/features/media-detail/light-novel/hooks/useLightNovelReviewSection";
    ...
    <div className="rounded-2xl border border-border/40 bg-background/35 shadow-xs backdrop-blur-xs">
      ...
      <div className="flex flex-col gap-4 p-4 sm:gap-5 sm:p-5">
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          <div className="flex items-center gap-3 rounded-lg border border-border/40 bg-background/35 p-3 shadow-xs backdrop-blur-xs">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-linear-to-br from-rose-500/25 to-red-500/20">
