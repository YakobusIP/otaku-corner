...
const AddAnimeDialog = lazy(
  () => import("@/features/add-media/components/add-anime/AddAnimeDialog")
);
const AddMangaDialog = lazy(
  () => import("@/features/add-media/components/add-manga/AddMangaDialog")
);
const AddLightNovelDialog = lazy(
  () => import("@/features/add-media/components/add-lightnovel/AddLightNovelDialog")
);
